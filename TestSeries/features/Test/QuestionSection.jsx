...
const QuestionSection = ({
  ...
  const isAnswered = (() => {
    ...
    switch (question_type) {
      ...
      case "numerical":
        return (
          typeof option === "string" && option.trim() !== "" && !isNaN(option)
        );
      case "match":
        return (
