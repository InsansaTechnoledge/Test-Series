...
const QuestionListSection = ({eventDetails, selectedQuestion, setSelectedQuestion, subjectSpecificQuestions, setSubjectSpecificQuestions, selectedSubject, setSelectedSubject}) => {
        ...
        <div className='flex space-x-2 px-2 border-l-2 h-full'>
            {
                ...
                :
                <TestSubjectSelectionBar selectedSubject={selectedSubject} setSelectedSubject={setSelectedSubject} eventDetails={eventDetails} setSubjectSelectionVisible={setSubjectSelectionVisible}/>
            }
