...
const Navbar = () => {
  ...
  return (
    <div className="w-full relative">
      {/* Main Navigation */}
      <div className="bg-blue-200 mx-12 mt-4 py-3 rounded-2xl">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Logo Pill */}
            <div className="bg-gray-700 rounded-full px-3 sm:px-6 py-2 border border-white/20">
            ...
            <div className="hidden md:flex flex-1 max-w-2xl mx-8">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-500 border border-white/20 rounded-full text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-700 rounded-full border border-white/20 flex items-center justify-center hover:bg-gray-800">
