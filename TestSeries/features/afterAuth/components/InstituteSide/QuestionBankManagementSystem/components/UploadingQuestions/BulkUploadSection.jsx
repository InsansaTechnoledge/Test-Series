...
import BulkUpload from '../../../ExamFlow/components/BulkUpload'
import { handleSubmitExam } from './handleSubmit'

const BulkUploadSection = ({organizationId , questions , setQuestions}) => {
  ...
  return (
    <div>
      ...
      <button
        ...
        className={`mt-12 w-full md:w-auto px-6 py-2 rounded-lg text-white font-semibold transition ${
