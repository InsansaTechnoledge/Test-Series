  ...
  const handleSubmit = async (e) => {
    ...
    <div className={`min-h-screen p-4 md:p-8 `}>
      ...
      <div className="max-w-4xl mx-auto py-2">
        ...
        {/* Header */}
        <div className={`text-center py-3 ${theme === 'light' ? 'bg-gradient-to-r from-indigo-600 to-gray-600' : 'bg-gradient-to-r from-indigo-700 to-gray-800'} text-white relative overflow-hidden rounded-t-2xl`}>
        ...
        {/* Main Form Container */}
        <div className={`rounded-2xl shadow-2xl overflow-hidden ${theme === 'light' ? 'bg-white border border-blue-100' : 'bg-gray-800 border border-gray-700'}`}>
          {/* Status Messages */}
          {(loading || successMessage || errorMessage) && (
            <div className={`p-6 ${theme === 'light' ? 'border-b border-blue-50' : 'border-b border-gray-700'}`}>
              {loading && (
                <div className={`flex items-center p-4 rounded-xl ${theme === 'light' ? 'bg-blue-50' : 'bg-blue-900/30'}`}>
                  <Loader className={`w-5 h-5 animate-spin mr-3 ${theme === 'light' ? 'text-blue-500' : 'text-blue-400'}`} />
                  <span className={`font-medium ${theme === 'light' ? 'text-blue-700' : 'text-blue-300'}`}>Updating student information...</span>
                </div>
              )}
              {successMessage && (
                <div className={`flex items-center p-4 rounded-xl ${theme === 'light' ? 'bg-green-50' : 'bg-green-900/30'}`}>
                  <CheckCircle className={`w-5 h-5 mr-3 ${theme === 'light' ? 'text-green-500' : 'text-green-400'}`} />
                  <span className={`font-medium ${theme === 'light' ? 'text-green-700' : 'text-green-300'}`}>{successMessage}</span>
                </div>
              )}
              {errorMessage && (
                <div className={`flex items-center p-4 rounded-xl ${theme === 'light' ? 'bg-red-50' : 'bg-red-900/30'}`}>
                  <XCircle className={`w-5 h-5 mr-3 ${theme === 'light' ? 'text-red-500' : 'text-red-400'}`} />
                  <span className={`font-medium ${theme === 'light' ? 'text-red-700' : 'text-red-300'}`}>{errorMessage}</span>
                </div>
              )}
            </div>
          )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center mb-6">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${theme === 'light' ? 'bg-blue-100' : 'bg-blue-900/50'}`}>
                    <User className={`w-4 h-4 ${theme === 'light' ? 'text-blue-600' : 'text-blue-400'}`} />
                  </div>
                  <h2 className={`text-xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>Student Details</h2>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <User className={`absolute left-4 w-5 h-5 top-1/2 transform -translate-y-1/2 ${theme === 'light' ? 'text-gray-400' : 'text-gray-500'}`} />
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <Mail className={`absolute left-4 w-5 h-5 top-1/2 transform -translate-y-1/2 ${theme === 'light' ? 'text-gray-400' : 'text-gray-500'}`} />
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <Phone className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 ${theme === 'light' ? 'text-gray-400' : 'text-gray-500'}`} />
                    <input
                      type="text"
                ...
                {/* Gender */}
                <div className="group">
                  <label className={`block text-sm font-semibold mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Gender</label>
                  <select
                    value={gender}
              ...
              <div className="space-y-6">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className={`text-xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>Parent & Batch Info</h2>
                </div>

                {/* Parent Email */}
                <div className="group">
                  <label className={`block text-sm font-semibold mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Parent Email</label>
                  <div className="relative">
                    <input
                      type="email"
                    ...
                    />
                    <Mail className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 ${theme === 'light' ? 'text-gray-400' : 'text-gray-500'}`} />
                  </div>
                </div>

                {/* Parent Phone */}
                <div className="group">
                  <label className={`block text-sm font-semibold mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Parent Phone</label>
                  <div className="relative">
                    <input
                      type="text"
                    ...
                    />
                    <Phone className={`absolute left-4 w-5 h-5 top-1/2 transform -translate-y-1/2 ${theme === 'light' ? 'text-gray-400' : 'text-gray-500'}`} />
                  </div>
                </div>

                {/* Batch Assignment */}
                <div className="group">
                  <label className={`block text-sm font-semibold mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Batch Assignment</label>
                  <select
                    value={currentBatch}
                ...
                <div className={`p-4 rounded-xl border ${theme === 'light' ? 'bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200' : 'bg-gradient-to-r from-blue-900/30 to-blue-800/30 border-blue-700'}`}>
                  <p className={`text-sm mb-1 ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'}`}>Currently Assigned:</p>
                  <p className={`font-semibold ${theme === 'light' ? 'text-blue-700' : 'text-blue-300'}`}>{batchMap?.[currentBatch]?.name || 'No Batch Selected'}</p>
                </div>
              </div>
            </div>

            {/* Submit Button */}
            <div className={`mt-10 pt-6 flex justify-center ${theme === 'light' ? 'border-t border-gray-100' : 'border-t border-gray-700'}`}>
              <button
                type="submit"
                disabled={loading}
