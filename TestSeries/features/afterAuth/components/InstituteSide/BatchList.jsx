            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <input
                  ...
                  } rounded-2xl pl-12 pr-6 py-3 w-80`}
                ...
                <div className="flex justify-center space-x-3">
                  {canViewBatch && (
                    <button
                      ...
                      } p-3 rounded-xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2`}
                  ...
                  {canDeleteBatch && (
                    <button
                      ...
                      } z-10 cursor-pointer p-3 rounded-xl transition-all duration-300 hover:scale-105`}
