          ...
          <div className="space-y-4">
            {filteredQuestions.length > 0 ? (
              filteredQuestions.map((q, index) => (
                <div
                  key={q.id}
                  className={`rounded-xl border shadow-sm hover:shadow-md transition duration-200 overflow-hidden ${theme == 'light'
                    ? "border-gray-200 bg-white"
                    : "border-gray-600 bg-gray-800"
                    }`}
                >
                  <div
                    className={`p-4 border-b flex justify-between items-center cursor-pointer ${theme == 'light'
                      ? "border-gray-200 bg-white"
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-3 flex-wrap">
                        <span className={`font-medium ${theme == 'light' ? 'text-gray-500' : 'text-gray-400'
                          }`}>#{index + 1}</span>
                        <span className={`px-2 py-0.5 rounded text-xs uppercase font-medium ${theme == 'light'
                      ...
                      <div className="flex items-center justify-between mt-2 gap-4">
                        <div className={`font-medium line-clamp-1 ${theme == 'light' ? 'text-gray-800' : 'text-white'}`}>
                          {q.question_text}
                        </div>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            const updatedQuestions = questions.map((ques) =>
                              ques.id === q.id ? { ...ques, bloom_level: e.target.value, bloom_match: true } : ques
                            );
                    ...
                    <button className={`transition-colors duration-200 ${theme == 'light'
                  ...
                  {expandedQuestion === q.id && (
                    <div className={`p-4 ${theme == 'light' ? 'bg-white' : 'bg-gray-800'
                      ...
                      {(q.type === 'mcq' || q.type === 'msq') && q.options && q.options.length > 0 && (
                        <div className="mb-4">
                          <h3 className={`font-medium mb-2 ${theme == 'light' ? 'text-gray-700' : 'text-gray-300'
                            }`}>Options:</h3>
                          <div className="space-y-2 pl-2">
                            {q.options.map((option, i) => (
                              ...
                              >
                                <div className={`w-6 h-6 flex items-center justify-center rounded-full mr-3 flex-shrink-0 ${theme == 'light'
                                ...
                                {q.type === 'mcq' && q.correct_option === i && (
                                  <div className={`ml-auto font-medium text-sm ${theme == 'light' ? 'text-green-600' : 'text-green-400'
                                    }`}>Correct</div>
                                )}
                      ...
                      {(q.type === 'fill' || q.type === 'numerical') && (
                        <div className="mb-4">
                          ...
                          <div className={`pl-2 border-l-4 py-1 ${theme == 'light'
                      ...
                      {q.type === 'code' && (
                        <div className={`space-y-4 border rounded-lg p-6 shadow-sm ${theme == 'light'
                          ? 'bg-white border-blue-200'
                          : 'bg-gray-700 border-blue-600'
                          }`}>
                          <h2 className={`text-2xl font-semibold ${theme == 'light' ? 'text-blue-800' : 'text-blue-300'
                            }`}>{q.title}</h2>
                          ...
                          <div>
                            <h3 className={`font-semibold mb-1 ${theme == 'light' ? 'text-gray-700' : 'text-gray-300'
                              }`}>Prompt:</h3>
                            <p className={`whitespace-pre-wrap ${theme == 'light' ? 'text-gray-800' : 'text-gray-200'
                              }`}>{q.prompt}</p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <pre className={`p-3 rounded text-sm ${theme == 'light'
                          ...
                          {q.constraints?.length > 0 && (
                            <div>
                              ...
                              <ul className={`list-disc pl-5 ${theme == 'light' ? 'text-gray-800' : 'text-gray-200'
                                }`}>
                          ...
                          {q.examples?.length > 0 && (
                            <div>
                              ...
                              {q.examples.map((ex, i) => (
                                <div key={i} className={`border rounded p-3 mb-2 ${theme == 'light'
                          ...
                          {q.test_cases?.length > 0 && (
                            <div>
                              ...
                              {q.test_cases.map((tc, i) => (
                                <div key={i} className={`border rounded p-3 mb-2 text-sm ${theme == 'light'
                          ...
                          <div>
                            <h4 className={`font-medium mb-2 ${theme == 'light' ? 'text-gray-700' : 'text-gray-300'
                              }`}>Starter Code</h4>
                            <div className="space-y-3">
                              {Object.entries(q.starter_code || {}).map(([lang, code]) => (
                                code && (
                                  <div key={lang}>
                                    <p className={`text-sm font-semibold capitalize ${theme == 'light' ? 'text-gray-600' : 'text-gray-400'
                                      }`}>
                                      {lang === 'cpp' ? 'C++' : lang}
                                    </p>
                                    <pre className={`p-3 rounded overflow-x-auto text-xs ${theme == 'light'
                                      ? 'bg-gray-100 text-gray-800'
                                      : 'bg-gray-800 text-gray-200'
                                      }`}>{code}</pre>
                                  </div>
                      ...
                      {q.type === 'match' && (
                        <div className="mb-4">
                          ...
                          <div className={`grid grid-cols-2 gap-4 p-3 rounded border ${theme == 'light'
                            ? 'bg-gray-50 border-gray-200'
                            : 'bg-gray-700 border-gray-600'
                            }`}>
                            <div>
                              <h4 className={`font-semibold text-sm mb-2 ${theme == 'light' ? 'text-gray-600' : 'text-gray-400'
                                }`}>Left Items</h4>
                              {q.left_items?.map((item, i) => (
                                <div key={i} className={`py-1 ${theme == 'light' ? 'text-gray-800' : 'text-gray-200'
                                  }`}>{`${i + 1}. ${item}`}</div>
                              ))}
                            </div>
                            <div>
                          ...
                          {q.correct_pairs && typeof q.correct_pairs === 'object' ? (
                            <div className="mt-4">
                              <h4 className={`font-semibold text-sm mb-1 ${theme == 'light' ? 'text-green-700' : 'text-green-400'
                                }`}>Correct Pairs:</h4>
                              <div className={`text-sm p-2 rounded space-y-1 ${theme == 'light'
                                ...
                                {Object.entries(q.correct_pairs).map(([leftVal, rightVal], i) => (
                                  <div key={i}>
                                    ...
                                    <span className={`font-semibold ml-1 ${theme == 'light' ? 'text-green-700' : 'text-green-400'
                                      }`}>{rightVal}</span>
                                  </div>
                                ))}
                                <p className={`text-xs italic mt-1 ${theme == 'light' ? 'text-gray-500' : 'text-gray-400'
                                  }`}>
                      ...
                      {q.type === 'comprehension' && (
                        <div className="mb-4">
                          ...
                          <div className={`pl-2 border-l-4 py-2 whitespace-pre-line ${theme == 'light'
                          ...
                          {Array.isArray(q.sub_question_ids) && q.sub_question_ids.length > 0 ? (
                            <div className="mt-4 space-y-4">
                              <h4 className={`font-semibold text-sm ${theme == 'light' ? 'text-gray-700' : 'text-gray-300'
                                }`}>Sub-Questions:</h4>

                              {q.sub_question_ids.map((sub, subIndex) => (
                                <div key={sub.id} className={`p-3 rounded border space-y-2 ${theme == 'light'
                                  ? 'bg-gray-50 border-gray-200'
                                  : 'bg-gray-700 border-gray-600'
                                  }`}>
                      ...
                      <div className={`flex justify-end mt-4 pt-4 border-t ${theme == 'light' ? 'border-gray-200' : 'border-gray-600'
                        }`}>
                        <button
                          className={`px-3 py-1 border rounded transition-colors duration-200 ${theme == 'light'
              ...
              <div className={`p-6 rounded text-center shadow ${theme == 'light'
