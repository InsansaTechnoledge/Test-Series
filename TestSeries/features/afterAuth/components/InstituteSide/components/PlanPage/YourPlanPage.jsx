  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
          <div className="flex flex-col sm:flex-row sm:items-center mt-22 sm:justify-between space-y-4 sm:space-y-0">
            <div className="text-center sm:text-left">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 sm:mb-4 text-white">Your Plan</h1>
              <p className="text-lg sm:text-xl text-gray-300">Manage your subscription and view usage statistics</p>
            </div>
            <div className="flex justify-center sm:justify-end">
              <span className={`inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8 sm:space-y-12">
        {/* Usage Stats */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-white text-center sm:text-left">Your Stats</h2>
        ...
        <div className="bg-gray-900 rounded-lg p-6 sm:p-8 border border-gray-800">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-white text-center sm:text-left">Features included with existing plan</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
            {Object.entries(features).map(([key, value]) => {
              const isEnabled = typeof value === 'object' ? Object.values(value).some(v => v === true) : Boolean(value);
              return (
                <div key={key} className={`p-4 sm:p-6 rounded-lg border-2 transition-all duration-300 ${
                  isEnabled 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                      <div className={`w-4 sm:w-5 h-4 sm:h-5 rounded-full flex-shrink-0 ${isEnabled ? 'bg-indigo-100' : 'bg-gray-600'}`}></div>
