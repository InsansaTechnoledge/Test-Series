...
const ContestInstructionWindow = () => {
    ...
    const handleStartContest = async () => {
        if (!guidelinesAccepted) {
            alert("Please accept the contest guidelines to proceed.");
            return;
        ...
        <div className={`${
          ...
          <div className={`space-y-4 ${
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg leading-relaxed">All entries must be submitted before the contest end date.</p>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-2xl">🛠️</span>
              <p className="text-lg leading-relaxed">Technical issues should be reported immediately to the support team.</p>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-2xl">🔐</span>
              <p className="text-lg leading-relaxed">Participant data is handled securely and in compliance with privacy policies.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center space-y-6">
        <div className="max-w-2xl w-full">
          <label className="flex items-start cursor-pointer group">
            ...
            />
            <span className={`ml-4 text-lg leading-relaxed ${
              theme === 'light' ? 'text-gray-700' : 'text-gray-300'
