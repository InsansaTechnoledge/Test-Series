...
const UpcomingExam = () => {
  ...
  const answer =
    "Use the created role groups to assign permissions to users in your add user section.";
    ...
    setTimeout(() => {
      if (notification.parentNode) {
        notification.style.animation =
          "slideOutBounce 0.4s cubic-bezier(0.6, -0.28, 0.735, 0.045)";
        setTimeout(() => {
          if (notification.parentNode) {
  ...
  const startProctorEngine = async (examId, eventId = "default") => {
    ...
    try {
      ...
      if (result.success) {
        ...
        showToast(`Failed to start proctor: ${result.message}`, "error");
        return false;
      }
    } catch (error) {
      setProctorStatus("idle");
      ...
      showToast(`Error starting proctor: ${error.message}`, "error");
      return false;
    }
  };
  ...
  const handleStartTest = async (examId, isAiProctoredFlag) => {
    ...
    if (!userId || !examId) {
      showToast("Missing required information to start the exam", "warning");
      return;
    }
    ...
    if (isProctored) {
      ...
      if (isElectronEnv) {
        console.log(
          "AI-proctored exam in Electron environment - starting proctor engine"
        );
        ...
        if (proctorStarted) {
          ...
          setTimeout(() => {
            navigate(
              `/student/test?userId=${userId}&examId=${examId}&eventId=${eventId}&proctored=true`
            );
          }, 2000);
        } else {
        ...
        showToast(
          "AI-proctored exams require the desktop application. Please use the Evalvo Proctor desktop app to take this exam.",
          "error"
        );
      }
    } else {
      ...
      console.log(
        "Non-AI proctored exam - launching directly without proctor engine"
      );
      handleStartTestFallback(examId);
    }
  };
  ...
  const handleStartTestFallback = (examId) => {
    ...
    const eventId = "default";
    navigate(
      `/student/test?userId=${userId}&examId=${examId}&eventId=${eventId}`
    );
  };
              ...
              >
                ...
                >
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 text-xs mt-1">●</span>
                    <span>
                      Print, Save, and View Source operations are blocked
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 text-xs mt-1">●</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 text-xs mt-1">●</span>
                    <span>
                      Page refresh and URL tampering attempts are monitored
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 text-xs mt-1">●</span>
              ...
              >
                ...
                >
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 text-xs mt-1">●</span>
                    <span>
                      Facial recognition is used throughout the session
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 text-xs mt-1">●</span>
                    <span>
                      Multiple face detection to avoid unauthorized presence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 text-xs mt-1">●</span>
                    <span>
                      Proper lighting and solitary environment are mandatory
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-8">
                {liveExams && liveExams.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="relative z-10 p-8">
                          ...
                          <button
                            ...
                            disabled={
                              !canStartExam(exam) || exam.hasAttempted === true
                            }
                            className={`
                  ...
                  >
                    ...
                    >
                      There are currently no active exams. Check back later or
                      view upcoming exams below.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-8">
                {upcomingExams && upcomingExams.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      There are no scheduled exams at the moment. Check with
                      your instructor for updates.
                    </p>
                  </div>
                )}
              </div>
