...
import LogRoutes from './mongoRoutes/FirstDB/logs.routes.js'
import aiRoutes from './openAi/ai.routes.js'
...
const routes = (app) => {
    ...
    registerRoute(app , '/api/v1/logs' , LogRoutes)

    registerRoute(app, '/api/v1/ai' , aiRoutes)
